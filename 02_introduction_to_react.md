...
<sub>Author:
<a href="https://www.linkedin.com/in/asabeneh/" target="_blank">Eric Muriuki</a><br>
<small> May 16th</small>
</sub>
      ...
      const header = (
        <header>
          <div className='header-wrapper'>
            ...
            <h2>Getting Started React</h2>
            <h3>JavaScript Library</h3>
            <p>Instructor: Eric Muriuki</p>
            <small>Date: May 16, 2025</small>
          </div>
        </header>
      )
